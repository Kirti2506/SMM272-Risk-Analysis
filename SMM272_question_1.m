...
% Group number:4
% Group member: 1.) Kirti Balina
%               2.) Syairazi Bin Mahdhar
%               3.) Mattis Menebroecker
%               4.) Saran Somboonsiripok
% ===================================================================
% Question 1.) Statistical Analysis
% Select the following stocks (INTC, JPM, AA, PG, MSFT) and download their historical adjusted close
% price from Yahoo finance (or other sources) for the period Jan 1st, 2014 to 31th of December 2023
% (included). Then build an equally weighted portfolio and perform the following analysis discussing
% carefully the adopted procedure and your findings
...
%% Question 1.1) Perform a statistical analysis of the portfolio returns
...
%% Question 1.2)
% Using a rolling window of 6 months and starting on July 1st 2014, you have to estimate for each
% day the VaR at 90% and 99% confidence levels at one day horizon using at least three different
% methods at your own choice.
...
grid on;
%% Question 1.3)
% Given your VaR forecasts, compute the number of VaR violations for each model and each
% confidence level.
...
%% Question 1.4)
% Is the number of violations as large as expected? Perform the Kupiec test (at significance level
% of 95%). Produce a Table showing for each combination of models and confidence level the
% number of violations, the value of the likelihood ratio and your decision about the model accuracy.
...
%% Question 1.5)
% Do you see (if yes provide details on how you have detected it) any serial dependence in the
...
%% Question 1.6)
% Read the pages on conditional coverage test and on a distributional test according to the procedure
% described in the Christoffersen book and implement it.
