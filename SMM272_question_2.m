...
% ===================================================================
% Question 2.) The risk parity portfolio
% The risk parity portfolio is a portfolio having the same Component VaR for each asset.
% You can build the risk-parity portfolio by choosing the weights that minimize the 
% dispersion (i.e. the standard deviation) of the individual CVaRs. Using the data set 
% in Question 1, use the first half of the sample to build the risk-parity portfolio using 
% the parametric (i.e. implemented using the sample covariance matrix) approach. Using the 
% second half of your sample, compute the daily log-return of the poftfolio and of the 
% equally weighted portfolio. As performance measures, report the Sharpe index of each 
% portfolio, the maximum drawdown (search on the web its meaning: Matlab has a function to
% compute it) and the number of VaR violations at 95% confidence level. Comment your results.
%% Importing data
rng(123)
